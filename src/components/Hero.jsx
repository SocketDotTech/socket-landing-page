    ...
    <div className="bg-socket-theme pt-[8.75rem] pb-[6.25rem]">
      <div className="flex flex-col gap-3 items-center">
        ...
        <p className="text-white font-medium text-lg max-w-[644px] text-center">
          ...
          data transfers across chains, enabling developers to build truly cross
          chain apps
        </p>
        <div className="flex gap-3">
          <Button type="link" url="https://docs.socket.tech/" external bgColor="bg-socket-gray-100">Read Documentation</Button>
          <Button type="link" url="https://bungee.exchange/" external bgColor="bg-white" textColor="text-socket-gray-100">Try it on Bungee</Button>
        </div>
      </div>
    </div>
  );
